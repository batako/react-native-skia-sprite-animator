...
- SpriteAnimator remains available in v0.4.0 but now emits a deprecation warning and will be removed in the next release (see [`0a11e64`](https://github.com/batako/react-native-skia-sprite-animator/commit/0a11e64), [`b47500c`](https://github.com/batako/react-native-skia-sprite-animator/commit/b47500c)).
